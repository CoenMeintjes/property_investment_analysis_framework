...
|------------------------|---------------------------------------------------------------|
| Location               | The geographic location of the property including address, suburb, city, municipality, and province. |
...
| Title Type             | The type of property title, such as freehold or sectional title.|
...
| Bundle Acq. Loan Fees | A binary column indicating whether the fees associated with the loan are included in the loan amount or paid out of pocket. |
...
| Typical Regional Cap Rate | The average capitalisation rate specific to the regional market, used for investment analysis purposes. |
...
In this section, we have outlined the data collection process undertaken for this analysis, which forms the foundation for assessing the feasibility of the property investment. The next crucial step is to design and calculate the necessary metrics that will enable an effective evaluation of the property's viability as an investment.
...
| Metric | Formula | Description |
| --- | --- | --- |
| Holding Costs | … | The total holding costs during the estimated rehab time, including monthly principal and interest payment and fixed expenses multiplied by the rehab time. |
| Total Cash Outlay | … | The total cash outlay required for the property, including the cash needed at purchase and the holding costs during the rehab period. |
...
| Metric | Formula | Description |
| --- | --- | --- |
| Gross Income (m)           | … | The total annual gross income generated by the property, including the total gross rent and any other additional income sources.   |
| Total Expenses (m)         | … | The total annual expenses associated with the property, including both fixed and variable expenses.                               |
| Initial Cashflow (m)       | … | The net cash flow generated by the property during the initial rental period.                                                      |
| Initial NOI                | … | The net operating income (NOI) of the property during the initial rental period, calculated by deducting the fixed expenses from the gross income. |
| Pro Forma Cap Rate         | … | The capitalisation rate (Cap Rate) of the property, based on the initial NOI and the total project cost adjusted for the holding costs. |
| Purchase Cap Rate          | … | The capitalisation rate (Cap Rate) of the property at the time of purchase, based on the initial NOI and the total project cost.
| Initial Cash on Cash ROI (y) | … | The annualised cash-on-cash return on investment (ROI) during the initial rental period, calculated by dividing the annual cash flow by the cash invested at purchase. |
...
| Metric | Formula | Description |
| --- | --- | --- |
| Total Ref. Loan        | … | The total amount of the refinance loan obtained after the property has been renovated and its value has increased. |
| Ref. Loan Total Fees   | … | The total fees associated with obtaining the refinance loan, including charges and other costs. |
| Ref. Monthly P&I | … | The monthly principal and interest (P&I) payment for the refinance loan. |
| Total Cash Invested    | … | The total cash invested in the property, calculated as (look at formula) the cash needed at purchase minus the initial cash flow generated during the initial rental period. |

### **Refinanced Rental Period Metrics**
...
| Metric | Formula | Description |
| --- | --- | --- |
| Ref. Gross Income (m)  | … | The total gross income generated by the property during the refinanced rental period, including rental income and other sources of income. |
| Ref. Total Expenses (m)  | …  | The total expenses incurred during the refinanced rental period, encompassing all relevant costs associated with property ownership, such as operating expenses, maintenance costs, property management fees, and other expenses. |
| Ref. Cashflow (m)        | …  | The net cash flow generated by the property during the refinanced rental period, calculated as the difference between the gross income and total expenses. It reflects the available cash after covering all expenses. |
| Ref. NOI                 | …  | The net operating income of the property during the refinanced rental period, obtained by deducting operating expenses from the gross income. It represents the property's profitability before considering financing and taxes. |
| Ref. Cash on Cash ROI (y)| …  | The cash-on-cash return on investment expressed as a percentage per year during the refinanced rental period. It measures the annual return generated from the cash invested in the property, taking into account the refinanced loan and the cashflow. |
...
| Metric | Formula | Description |
| --- | --- | --- |
| 2% Rule                   | …   | Determines if the monthly rental income is at least 2% of the total acquisition cost. |
| Total Initial Equity      | …   | Represents the total amount of cash invested in the property at the initial stage, including the down payment, closing costs, and estimated rehabilitation costs. | …  |
| Gross Rent Multiplier     | …   | Measures the relationship between the purchase price of the property and its gross rental income. It helps assess the investment's income potential. |
| Acq. Debt Coverage Ratio   | …  | Calculates the property's ability to generate sufficient income to cover the monthly mortgage payment and associated expenses during the acquisition period. |
| Ref. Debt Coverage Ratio   | …  | Assesses the property's ability to generate sufficient income to cover the monthly mortgage payment and associated expenses after refinancing. |
| Deal Check                 | …  | Evaluates the overall feasibility and profitability of the investment based on various financial factors and metrics. |
...
| Metric | Formula | Description |
| --- | --- | --- |
| Cashflow Score       | …  | Evaluates the cashflow generated by the property, considering income and expenses, to determine its financial viability.               |
| Debt Coverage Score  | …  | Assesses the property's ability to cover the monthly mortgage payment and associated expenses, indicating its financial stability.      |
| Property Score       | …  | Aggregates various factors, such as location, condition, and market potential, to provide an overall score for the property's desirability. |
| Property Rank        | …  | Ranks the property among other investment options based on its performance and desirability factors.                                     |
| Offer To Purchase    | …  | Determines the recommended offer or purchase price for the property based on the analysis and evaluation conducted.                      |
